...
?>
 ...
 <header class="main-header">
		...
		<h1 class="page-title"><center>LIST OF "WHAT ID DIABETES"</center> <span class="title-under"></span></h1>
 ...
 echo "<table align=center border=0  cellpadding=40 cellspacing=40  \n";
			  ...
			  do{
				printf("<tr><td align=center>%s &nbsp;&nbsp;&nbsp;&nbsp;</td><td align=center>%s</td></tr>\n",
					   $row['title'],"<a href='what2delete.php?title=".$row['infoID']."'><u>Read Now</u></a>");
