...
<html class="no-js">
    <head>
        <meta charset="utf-8">
        <title>Food Planning for Diabetes| Diabetes Prediction System</title>
...
?>
 ...
 <header class="main-header">
   ...
   <div>
     ...
     <form action='deleteInfoProcess.php?title="<?php echo $row['infoID']; ?>"' method="post">
        <input type="hidden" name="name" value="<?php echo $row['infoID']; ?>">
        <input type="submit" class="btn btn-primary pull-right" name="submit" value="Delete"> 
    </form>
...
onclick="window.location='fooddelete.php'" />
			<br><br><br><br>
                        </div>
