...
<table>
   ...
   <div>
     ...
     <form action='deleteInfoProcess.php?title="<?php echo $row['infoID']; ?>"' method="post">
        ...
        <input type="submit" class="btn btn-primary pull-right" name="submit" onClick="return confirm('Are you sure you want to delete?')" value="Delete"> 
    </form>
...
onclick="window.location='whatdelete.php'" />
			<br><br><br><br>
                        </div>
