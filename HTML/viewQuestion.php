...
<html class="no-js">
    <head>
        <meta charset="utf-8">
        <title>View Question| Diabetes Prediction System</title>
...
if(!empty($g)){
	...
	<tr><td  align="center"><b>'.$a.'</b>	&nbsp;<b>'.$b.'</b></td></tr>
	<tr><td align="center"><input type="radio" name="'.$a.'" value="'.$row['mark1'].'" /> '.$c.'    </td></tr>
	<tr><td align="center"><input type="radio" name="'.$a.'" value="'.$row['mark2'].'" />   '.$d.'    </td></tr>
	<tr><td align="center"><input type="radio" name="'.$a.'" value="'.$row['mark3'].'" />   '.$e.'    </td></tr>
	<tr><td align="center"><input type="radio" name="'.$a.'" value="'.$row['mark4'].'" />   '.$f.'      </td></tr>
	<tr><td align="center"><input type="radio" name="'.$a.'" value="'.$row['mark5'].'" />    '.$g.'    </td></tr>
</tr></table><br><br>';}
...
if(empty($e)){
	...
	<tr><td align="center"><input type="radio" name="'.$a.'" value="'.$row['mark1'].'" /> '.$c.'    </td></tr>
	<tr><td align="center"><input type="radio" name="'.$a.'" value="'.$row['mark2'].'" />   '.$d.'    </td></tr>
	<tr><td align="center"><input type="hidden" name="'.$a.'" value="'.$row['mark3'].'" />   '.$e.'    </td></tr>
	<tr><td align="center"><input type="hidden" name="'.$a.'" value="'.$row['mark4'].'" />   '.$f.'      </td></tr>
	<tr><td align="center"><input type="hidden" name="'.$a.'" value="'.$row['mark5'].'" />    '.$g.'    </td></tr>
</tr></table><br><br>';
}
