...
<html class="no-js">
    <head>
        <meta charset="utf-8">
        <title>DELETE INFO| Diabetes Prediction System</title>
 ...
 echo "<table align=center border=0  cellpadding=40 cellspacing=40  \n";
			  ...
			  do{
				printf("<tr><td align=center>%s &nbsp;&nbsp;&nbsp;&nbsp;</td><td align=center>%s</td></tr>\n",
					   $row['title'],"<a href='treatment2delete.php?title=".$row['infoID']."'><u>Read Now</u></a>");
...
onclick="window.location='deleteInfo.php'" />
<br><br><br><br>
                        </div>
