...
<html class="no-js">
    <head>
        <meta charset="utf-8">
        <title>Register Admin| Diabetes Prediction System</title>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-4 col-md-offset-1 col-contact">
					...
					<h2 class="title-style-2"> Register Admin <span class="title-under"></span></h2>

					<form action="admin2.php" method="post" class="contact-form ajax-form">
						  <div class="form-group">
	                            ...
	                            <input type="text" name="tel" class="form-control" placeholder="Admin No Phone*" required>
	                       </div>
  <div class="form-group">
