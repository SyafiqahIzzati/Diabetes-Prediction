...
$sql = "SELECT * FROM respond where status='notRead'; ";
...
do{
	...
	print('<a button href="display.php?id='.$row['respondID'].'"><img border="0" alt="W3Schools" src="mailsy.jpg" width="40" height="40">
			<b>You have message from '.$row['name'].'!!</b></a></td>
</tr></table><br><br>');
$r++;
...
while($row=mysqli_fetch_array($result));
			  ...
			  echo "<center><b>Sorry, no new message!</b></center>";  
