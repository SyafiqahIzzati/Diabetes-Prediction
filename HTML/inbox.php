...
?>
	...
	<h1 class="page-title"><center>LIST OF USER'S RESPOND</center> <span class="title-under"></span></h1>
...
$sql = "SELECT * FROM respond where status='already'; ";
...
do{
	...
	print('<tr><td><a button href="display2.php?id='.$row['respondID'].'"><img border="0" alt="W3Schools" src="mailsy.jpg" width="40" height="40">
			<b>from :'.$row['name'].'        <font size="1">'.$row['time'].'</font></b></a></td> 
			<td><a button href="deleter.php?id='.$row['respondID'].'" ><img border="0" alt="W3Schools" src="delete.png" width="40" height="40">
			</a><br><br></td>
</tr>');
$r++;
