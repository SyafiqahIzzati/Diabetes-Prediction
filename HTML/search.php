        ...
        echo "<td>".$results['lastName']."</td>";
		 echo "<td>".$results['email']."</td>";
		 		 echo "<td>".$results['gender']."</td>";
				 		 echo "<td><a href='deleteuser.php?title=".$results['email']."'><img border='0' alt='W3Schools' src='delete.png' width='40' height='40'></a></td>";
        echo "</tr>";
			...
			echo ("<script>alert('No results');document.location.href='user.php';</script>");
        }
         
    }
    else{ // if query length is less than minimum
      
					echo ("<script>alert('Minimum length is 3');document.location.href='user.php';</script>");
    }
?>
