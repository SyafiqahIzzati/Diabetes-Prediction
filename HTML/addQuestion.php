...
?>
 ...
 <header class="main-header">
	...
	<h1 class="page-title"><center>PLEASE ADD QUESTION</center> <span class="title-under"></span></h1>
			<p class="page-description">
				<center>Add questions for the Diabetes Prediction Questionnaire</center>
			</p>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-7 col-sm-12 col-form">
					...
					<h2 class="title-style-2">ADD QUESTIONS FORM <span class="title-under"></span></h2>

					<form action="addProcess.php" method="post" class="contact-form ajax-form">
						...
						<div class="form-group">
							...
							<div class="form-group col-md-6">
	                            <input type="text" name="answer1" class="form-control" placeholder="Enter the answer*" required>
	                        </div>

	                         <div class="form-group col-md-6">
	                            <input type="number" name="mark1" class="form-control" placeholder="Enter marks for answer*" required>
	                        </div>
							
								<div class="form-group col-md-6">
	                            <input type="text" name="answer2" class="form-control" placeholder="Enter the answer">
	                        </div>

	                         <div class="form-group col-md-6">
	                            <input type="number" name="mark2" class="form-control" placeholder="Enter marks for answer" >
	                        </div>
							
								<div class="form-group col-md-6">
	                            <input type="text" name="answer3" class="form-control" placeholder="Enter the answer" >
	                        </div>

	                         <div class="form-group col-md-6">
	                            <input type="number" name="mark3" class="form-control" placeholder="Enter marks for answer" >
	                        </div>
							
								<div class="form-group col-md-6">
	                            <input type="text" name="answer4" class="form-control" placeholder="Enter the answer" >
	                        </div>

	                         <div class="form-group col-md-6">
	                            <input type="number" name="mark4" class="form-control" placeholder="Enter marks for answer" >
	                        </div>
							
							
							
								<div class="form-group col-md-6">
	                            <input type="text" name="answer5" class="form-control" placeholder="Enter the answer" >
	                        </div>

	                         <div class="form-group col-md-6">
	                            <input type="number" name="mark5" class="form-control" placeholder="Enter marks for answer" >
	                        </div>
