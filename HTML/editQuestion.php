...
if(!empty($g)){
	...
	<tr><td align="left"><input type="radio" name="'.$a.'" value="'.$row['mark1'].'" /> '.$c.'    </td><td><a href="edit.php?id=' . $row['idquestionnaire'] . '">Edit</a></td></tr>
...
if(empty($e)){
	...
	<tr><td  align="left"><b>'.$a.'</b>	&nbsp;<b>'.$b.'</b></td><td><a href="edit.php?id=' . $row['idquestionnaire'] . '">Edit</a></td></tr>
