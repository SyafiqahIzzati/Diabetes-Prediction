...
<html class="no-js">
    <head>
        <meta charset="utf-8">
        <title>Diabetes Type 1| Diabetes Prediction System</title>
...
?>
 ...
 <header class="main-header">
		...
		<h1 class="page-title"><center>LIST OF "TYPE1 DIABETES"</center> <span class="title-under"></span></h1>
...
<br><br>
  <?php
			...
			// SQL statement
			$result = mysqli_query($con,"SELECT * FROM info where section='type1'");
 ...
 echo "<table align=center border=0  cellpadding=40 cellspacing=40  \n";
			  ...
			  do{
				printf("<tr><td align=center>%s &nbsp;&nbsp;&nbsp;&nbsp;</td><td align=center>%s</td></tr>\n",
					   $row['title'],"<a href='type12user.php?title=".$row['infoID']."'><u>Read Now</u></a>");
