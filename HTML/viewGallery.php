...
<html class="no-js">
    <head>
        <meta charset="utf-8">
        <title>Gallery | Diabetes Care</title>
...
?>
    ...
    <header class="main-header">
        ...
        <nav class="navbar navbar-static-top">
                ...
                <div id="navbar" class="navbar-collapse collapse pull-right">
                  ...
                  <ul class="nav navbar-nav">
                     ...
                     <li><a class="is-active" href="adminIndex.php">HOME </a></li>
                      ...
                      <ul class="submenu">
                         <li class="submenu-item"><a href="addGallery.php">Add Picture </a></li>
                         <li class="submenu-item"><a href="deletePicture.php">Delete Picture </a></li>
                         <li class="submenu-item"><a href="viewGallery.php">View Gallery </a></li>
			...
			<h1 class="page-title"><center>GALLERY </center><span class="title-under"></span></h1>
			<p class="page-description">
				<center>The Collection  of Diabetes Care </center>
			</p>
...
$query = mysqli_query($con,"SELECT id FROM files");
while($row = mysqli_fetch_assoc($query))
{
    $IDstore = $row['id'];
	

    echo "<img src='getImage.php?id=".$IDstore."'  width='175' height='200' >";
}
