...
?>
 ...
 <header class="main-header">
  ...
  <li><a  href="home.php">HOME </a></li>
		...
		<h1 class="page-title"><center>"BODY MASS INDEX CALCULATOR"</center> <span class="title-under"></span></h1>
			<p class="page-description">
				<center>CALCULATE YOUR BMI BEFORE ANSWER THE DIABETES PREDICTION QUESTION</center>
			</p>
	...
	<div class="main-container fadeIn animated">
		...
		<form action="riskquestion.php" method="post" class="contact-form ajax-form">

						<div class="row">
									       <div class="col-md-3 col-sm-6">
			
						Weight in KG :
        <input type="number" required name="weight" min="1" value="0" step=".01">
                        </div>
        ...
        <input type="number" required name="height" min="1" value="0" step=".01">
