...
<html class="no-js">
    <head>
        <meta charset="utf-8">
        <title>View Information| Diabetes Care</title>
...
?>
    ...
    <header class="main-header">
        ...
        <nav class="navbar navbar-static-top">
			...
			<h1 class="page-title"><center>INFO MENU </center><span class="title-under"></span></h1>
			<p class="page-description">
				<center>The Information Section </center><br>
				<center>*Choose the section that which is contain the information that you want to delete </center><br><br><br>
			</p>
...
<table cellpadding="3" width="500" border="0" align="center" >
<tr><td>
				<input type="button"class="btn btn-primary" name="What" value="What is Diabetes"
onclick="window.location='whatdelete.php'" /><br><br><br></td><td>
				<input type="button"class="btn btn-primary  " name="symptoms" value="Symptoms"
onclick="window.location='symptomsdelete.php'" /><br><br><br></td></tr>
			<tr><td>	<input type="button"class="btn btn-primary" name="type1" value="Type1 Diabetes"
onclick="window.location='type1delete.php'" /><br><br><br></td><td>
				<input type="button"class="btn btn-primary" name="type2" value="Type2 Diabetes"
onclick="window.location='type2delete.php'" /><br><br><br></td></tr>
			<tr><td>	<input type="button"class="btn btn-primary " name="complication" value="Diabetes Complication"
onclick="window.location='compdelete.php'" /><br><br><br></td><td>
				<input type="button"class="btn btn-primary" name="food" value="Food Planning"
onclick="window.location='fooddelete.php'" /><br><br><br></td></tr>
			<tr><td>	<input type="button"class="btn btn-primary " name="treatment" value="Treatment of Diabetes"
onclick="window.location='treatmentdelete.php'" /><br><br><br></td><td>
				<input type="button"class="btn btn-primary " name="new" value="News of Diabetes"
onclick="window.location='newdelete.php'" /><br><br><br></td></tr>
