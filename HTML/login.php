...
<html class="no-js">
    <head>
        <meta charset="utf-8">
        <title>Login| Diabetes Prediction System</title>
    ...
    <header class="main-header">
        ...
        <nav class="navbar navbar-static-top">
			...
			<h1 class="page-title"><center>PLEASE LOGIN</center> <span class="title-under"></span></h1>
			<p class="page-description">
				<center>Register to being able to predict your potential and know futher about Diabetes.</center>
			</p>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-4 col-md-offset-1 col-contact">
					...
					<h2 class="title-style-2"> Login User <span class="title-under"></span></h2>

					<form action="validateUser.php" method="post" class="contact-form ajax-form">
                         ...
                         <div class="form-group">
                            <button type="submit" class="btn btn-primary pull-right">Login Now</button>
                        </div>
				...
				<div class="col-md-4 col-md-offset-1 col-contact">
					...
					<h2 class="title-style-2"> Login as Admin <span class="title-under"></span></h2>

					<form action="validateAdmin.php" method="post" class="contact-form ajax-form">
