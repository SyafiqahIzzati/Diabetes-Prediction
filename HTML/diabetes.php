...
?>
 ...
 <header class="main-header">
		...
		<h1 class="page-title"><center>LIST OF "WHAT IS DIABETES"</center> <span class="title-under"></span></h1>
			<p class="page-description">
				<center>Below is the list of information reading</center>
			</p>
...
<br><br>
  <?php
			...
			// SQL statement
			$result = mysqli_query($con,"SELECT * FROM info where section='what'");
 ...
 echo "<table align=center border=0  cellpadding=40 cellspacing=40  \n";
			  ...
			  do{
				printf("<tr><td align=center>%s &nbsp;&nbsp;&nbsp;&nbsp;</td><td align=center>%s</td></tr>\n",
					   $row['title'],"<a href='what2user.php?title=".$row['infoID']."'><u>Read Now</u></a>");
			  ...
			  echo "<center><b>Sorry, information is not available for a while!</b></center>";  
