		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-4 col-md-offset-1 col-contact">
					...
					<form action="profile1.php" method="post" class="contact-form ajax-form">
						  <div class="form-group">

						
	                         <b> AdminID*:</b>  <input type="text" name="adminID" class="form-control" placeholder="AdminID*"      value="<?php echo $i; ?>" readonly>
	                       </div>						 <div class="form-group" >

						
	                     <b> Name: * </b>    <input type="text" name="name" class="form-control" placeholder="Name*"      value="<?php echo $m; ?>" required>
	                       </div>						   <div class="form-group">

						
	                     <b> Email:*  </b>    <input type="email" name="email" class="form-control" placeholder="Email*"      value="<?php echo $p; ?>" required>
	                       </div>						  <div class="form-group">

						
	                    <b>   No.Phone:</b><input type="text" name="tel" class="form-control" placeholder="Phone No."      value="<?php echo $q; ?>"  >
	                       </div>
