...
<html class="no-js">
    <head>
        <meta charset="utf-8">
        <title>Register| Diabetes Prediction System</title>
    ...
    <header class="main-header">
        ...
        <nav class="navbar navbar-static-top">
			...
			<h1 class="page-title"><center>PLEASE REGISTER</center> <span class="title-under"></span></h1>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-4 col-md-offset-1 col-contact">
					...
					<h2 class="title-style-2"> Register Now <span class="title-under"></span></h2>

					<form action="register2.php" method="post" class="contact-form ajax-form">
  ...
  <div class="form-group">
					...
					Already register ?
									<a href="login.php" class="to_register"><u>Login</u></a>
